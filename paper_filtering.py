...
def get_paper_ratings()->PaperRatings:
    """
    Get PaperRatings for recently published papers from the domains the user is interested in.
    :return: PaperRatings object with the rated papers
    """
...
def sort_papers(paper_ratings: PaperRatings)->Sequence[PaperRating]:
    """
    Convert the PaperRatings object to a sorted list of PaperRatings (sorted by descending average score).
    :param paper_ratings: The ratings to process.
    :return: PaperRatings sorted by descending average score.
    """
...
def get_most_interesting_papers(n: int)->Sequence[PaperRating]:
    """
    ...
    :return: Iterable of PaperRatings sorted by descending average score.
    """
